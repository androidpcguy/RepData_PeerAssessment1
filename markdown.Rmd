...
The mean number of steps taken per day is **`r mean_steps_tot`**.
The median number of steps taken per day is **`r median_steps_tot`**.
...
**The time interval with the most number of steps, on average, is `r max_interval` with `r max_val` number of steps.**
...
main="Histogram of steps per day after imputing NAs")
```
...
The mean number of steps taken per day after imputing NAs is **`r mean_steps`**.
The median number of steps taken per day after imputing NAs is **`r median_steps`**.
